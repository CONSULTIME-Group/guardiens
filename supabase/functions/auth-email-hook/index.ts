...
const SAMPLE_PROJECT_URL = "https://guardiens.lovable.app"
...
async function handlePreview(req: Request): Promise<Response> {
  ...
  const html = render(React.createElement(EmailTemplate, sampleData))
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  const html = render(React.createElement(EmailTemplate, templateProps))
  const text = render(React.createElement(EmailTemplate, templateProps), {
    plainText: true,
  })
