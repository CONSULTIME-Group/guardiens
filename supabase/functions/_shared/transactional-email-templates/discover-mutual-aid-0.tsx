...
const CTA_URL = `${SITE_URL}/login?redirect=${encodeURIComponent('/petites-missions/creer?utm_source=email&utm_medium=email&utm_campaign=discover_mutual_aid&utm_content=variant_0')}&utm_source=email&utm_medium=email&utm_campaign=discover_mutual_aid&utm_content=variant_0`
