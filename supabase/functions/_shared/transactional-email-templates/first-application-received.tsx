...
const h1 = { fontSize: '26px', fontWeight: 'bold' as const, color: '#2C6D50', margin: '0 0 16px' }
const lead = { fontSize: '16px', color: '#474238', lineHeight: '1.6', margin: '0 0 20px' }
...
const tips = { fontSize: '13px', color: '#7B756B', lineHeight: '1.7', margin: '0 0 16px' }
