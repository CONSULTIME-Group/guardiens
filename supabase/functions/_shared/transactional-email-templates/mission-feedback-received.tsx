...
const quote = { fontSize: '15px', color: '#44413B', lineHeight: '1.6', margin: '0 0 16px', padding: '12px 16px', borderLeft: '3px solid #2C6D50', backgroundColor: '#F1F9F5', fontStyle: 'italic' as const }
