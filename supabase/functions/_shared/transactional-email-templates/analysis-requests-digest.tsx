...
const row = { borderLeft: '3px solid #E9E4DD', padding: '6px 12px', margin: '0 0 10px' }
const rowLabel = { fontSize: '11px', color: '#2C6D50', fontWeight: 'bold' as const, textTransform: 'uppercase' as const, letterSpacing: '0.5px', margin: '0 0 2px' }
const rowSubject = { fontSize: '14px', color: '#44413B', margin: '0 0 2px', fontWeight: '600' as const }
const rowMeta = { fontSize: '12px', color: '#948E84', margin: 0 }
