...
const meta = { fontSize: '14px', color: '#736D64', lineHeight: '1.6', margin: '0 0 16px' }
const secondary = { fontSize: '13px', color: '#888277', margin: '18px 0 0' }
const secondaryLink = { color: '#888277', textDecoration: 'underline' }
