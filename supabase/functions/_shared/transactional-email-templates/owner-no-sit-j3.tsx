...
const baseline = { fontSize: '13px', color: '#2C6D50', fontWeight: '600' as const, margin: '4px 0 16px' }
...
const statBig = { fontSize: '18px', fontWeight: 'bold' as const, color: '#2C6D50', margin: '0 0 4px' }
