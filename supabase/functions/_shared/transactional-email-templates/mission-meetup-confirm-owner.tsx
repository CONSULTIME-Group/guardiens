...
const MissionMeetupConfirmOwnerEmail = ({
  ownerFirstName,
  helperFirstName,
  missionTitle,
  missionCity,
  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {helperFirstName || 'Une personne du coin'} a dit « Je peux » pour votre besoin. Dites-nous
          en un clic comment cela s'est passé.
        </Text>
        ...
        <Text style={muted}>
          ...
          {helperFirstName || 'la personne'}, si vous le souhaitez.
        </Text>
        ...
        <LegalFooter
          ...
          basis="6.1.b"
          extra="Vous recevez ce message car un coup de main a été organisé depuis votre demande d'entraide."
        />
      </Container>
    </Body>
  </Html>
...
export const template: TemplateEntry = {
  component: MissionMeetupConfirmOwnerEmail,
  subject: 'Vous vous êtes rencontrés ?',
  displayName: 'Entraide, fin d\u2019échange (demandeur)',
  previewData: {
