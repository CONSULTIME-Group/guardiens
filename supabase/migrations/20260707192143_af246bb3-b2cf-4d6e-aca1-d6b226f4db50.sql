...
DECLARE
  ...
  v_bypass boolean := coalesce(p_bypass_cooldown, false) OR coalesce(p_on_demand, false);
...
GRANT EXECUTE ON FUNCTION public.get_alma_cultural_fact(uuid, text, jsonb, boolean, uuid[], boolean) TO authenticated;