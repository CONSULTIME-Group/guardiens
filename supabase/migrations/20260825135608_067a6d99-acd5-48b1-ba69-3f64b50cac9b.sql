...
COMMENT ON FUNCTION public.notify_sitters_on_new_sit() IS 'Notifie les gardiens compatibles lors de la première publication d une annonce. Corrigé le 25/08/2026 pour lire les animaux via pets.property_id, source réelle des animaux rattachés au logement.';