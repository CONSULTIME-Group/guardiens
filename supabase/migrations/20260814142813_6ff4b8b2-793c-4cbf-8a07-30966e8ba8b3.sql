-- Le job d'analyse IA (cron quotidien 05:30 + rafraîchissement manuel) tourne en
-- service_role : le garde exigeait un uid admin humain et levait 'Not authorized'.
...
-- Horodatage du snapshot source, stocké à côté du texte généré (batch cohérence /admin).
ALTER TABLE public.admin_activity_analysis
