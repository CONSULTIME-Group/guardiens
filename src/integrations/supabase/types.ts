...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      _backup_cron_observability_20260920: {
        Row: {
          active: boolean | null
          command: string | null
          jobid: number | null
      ...
      _backup_identity_purge_rpc_20260918: {
        Row: {
          acl: unknown[] | null
          captured_at: string | null
          definition: string | null
      ...
      city_guide_places: {
        Row: {
          ...
          google_rating_attempted_at: string | null
      ...
      city_guides: {
        Row: {
          ...
          osm_enrich_last_result: string | null
          postal_code: string
          published: boolean
          seo_dirty_at: string | null
          slug: string
    ...
    Functions: {
      ...
      get_email_pipeline_health: {
        Args: { p_transactional_templates?: string[] }
        Returns: {
          attempts_1h: number
          deferred_abandoned_24h: number
          ...
          deferred_transactional_overdue_2h: number
