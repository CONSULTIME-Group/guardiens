  ...
  public: {
    ...
    Views: {
      ...
      pro_profiles_public: {
        Row: {
          approved_at: string | null
          category: Database["public"]["Enums"]["pro_category"] | null
          city: string | null
          cover_url: string | null
          created_at: string | null
          description: string | null
          ...
          status: Database["public"]["Enums"]["pro_moderation_status"] | null
          sub_categories: string[] | null
          tarif_max: number | null
          tarif_min: number | null
          tarif_note: string | null
          updated_at: string | null
          urgences_24_7: boolean | null
          user_id: string | null
          website: string | null
          zone_cities: string[] | null
          zone_radius_km: number | null
        }
        Insert: {
          approved_at?: string | null
