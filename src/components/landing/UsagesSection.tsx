  ...
  return (
    <section id="usages" className="py-[52px] md:py-20 bg-background scroll-mt-24">
      <div className="lp-read">
        ...
        <RevealSection className="mt-[34px]">
          ...
          <p className="text-center text-foreground/60 font-body max-w-2xl mx-auto mb-[34px] italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[14px]">
          <RevealSection delay={0.1}>
            <div className="bg-card rounded-2xl p-[22px] shadow-sm text-left h-full">
          ...
          <RevealSection delay={0.3}>
            <div className="bg-card rounded-2xl p-[22px] shadow-sm text-left h-full border-2 border-primary/20 relative overflow-hidden">
        ...
        <RevealSection delay={0.4}>
          <div className="mt-[22px] bg-accent/40 border border-accent rounded-2xl p-[22px] flex flex-col md:flex-row md:items-center md:justify-between gap-[14px]">
            <div>
