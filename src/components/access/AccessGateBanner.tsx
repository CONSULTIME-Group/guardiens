        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Inscrivez-vous, 0 €, pour accéder aux annonces et aux missions d'entraide.
            </p>
            <div className="flex gap-2">
              <Button size="sm" asChild>
                <Link to="/inscription">S'inscrire, 0 €</Link>
              </Button>
      ...
      <div className="rounded-lg p-5 space-y-3 bg-background border-l-4 border-primary">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              L'entraide est accessible, mais les gardes nécessitent l'activation de votre espace gardien.
            </p>
            <Button size="sm" asChild>
