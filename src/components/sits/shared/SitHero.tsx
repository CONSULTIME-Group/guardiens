    ...
    return (
      <div className="mb-6">
        <div
          ...
          className="w-full h-[260px] md:h-[520px] rounded-xl bg-muted/50 border border-dashed border-border flex flex-col items-center justify-center text-muted-foreground gap-2"
        >
      ...
      <div className="mb-6 relative">
        ...
        >
          {brokenIndices.has(photoIndex) ? (
            <div className="w-full h-[260px] md:h-[520px] bg-muted flex flex-col items-center justify-center text-muted-foreground gap-2">
            ...
            <img
              ...
              className="w-full h-[260px] md:h-[520px] object-cover transition-transform duration-500 group-hover:scale-[1.02]"
            />
          )}
