...
.join("");
 ...
 Personne de confiance : {garde.voisinConfiance.prenom} · {garde.voisinConfiance.telephone}
  ...
  <p className="text-sm">
  Cette garde est réalisée dans un esprit d'échange et de confiance mutuelle : {p} prête son logement à {g} à 0 €, pour des dates précises, et {g} s'engage à le restituer à la date prévue. Ce n'est ni un contrat de travail, ni un bail d'habitation : {g} ne reçoit aucune rémunération et ne devient jamais locataire.
  </p>
  <p className="text-sm mt-3">
