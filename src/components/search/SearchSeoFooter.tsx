 ...
 * Grenoble), pas de mention régionale (positionnement national).
 */
...
export const SEARCH_FAQ = [
  ...
  },
  {
    ...
    a: "La consultation est libre et gratuite, même sans compte. L'inscription est gratuite pour postuler à une annonce. L'espace propriétaire reste gratuit. L'espace gardien est ouvert pendant la phase de lancement.",
  },
  {
  ...
  >
    <div className="container max-w-6xl mx-auto px-4 py-12 md:py-16 space-y-12">
      <div>
        ...
        >
          Garde d'animaux à domicile, de maison et de jardin, ville par ville
        </h2>
