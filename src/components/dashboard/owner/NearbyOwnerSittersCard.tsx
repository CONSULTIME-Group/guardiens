      ...
      {isLoading ? (
        ...
        <div className="notebook-card relative p-4 pr-7 sm:p-5 sm:pr-8 min-w-0">
          ...
          <div className="relative flex flex-col gap-3">
            ...
            <Link
              to="/search?role=sitter"
              className="sm:shrink-0 inline-flex items-center justify-center gap-1.5 px-3 min-h-[44px] rounded-full border border-border bg-background text-[11px] font-semibold text-foreground hover:bg-muted/60 hover:border-foreground/30 transition-colors"
            >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <p className="text-sm font-semibold text-foreground break-words transition-colors group-hover:text-primary">
