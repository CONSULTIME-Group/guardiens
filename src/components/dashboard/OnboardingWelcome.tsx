...
const OnboardingWelcome = ({ role, checks, onDismiss }: OnboardingWelcomeProps) => {
  ...
  const sitterSteps: OnboardingStep[] = [
    ...
    },
    {
      key: "identity",
      icon: ShieldCheck,
      title: "Vérifiez votre identité (facultatif)",
      description: "Rien n'est bloqué sans elle, mais la vérification rassure les propriétaires et augmente vos chances d'être choisi.",
      link: "/settings?section=security&src=onboarding_welcome_sitter",
  ...
  const ownerSteps: OnboardingStep[] = [
    ...
    },
    {
      ...
      icon: ShieldCheck,
      title: "Vérifiez votre identité (facultatif)",
      description: "Rien n'est bloqué sans elle, mais c'est un gage de confiance pour les gardiens qui viendront chez vous.",
