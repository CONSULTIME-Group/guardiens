    ...
    <div className="space-y-8">
      ...
      {(() => {
        ...
        if (annoncesCount === 0) {
          ...
          resItems = [
            { title: "Rédiger une bonne annonce", description: "Ce qui attire les bons gardiens en 48h.", href: "/blog/rediger-bonne-annonce-house-sitting", icon: "maison" },
            { title: "Choisir son gardien : les bons critères", description: "Ce qui compte, ce qui ne sert à rien.", href: "/blog/choisir-gardien-bons-criteres", icon: "proprio" },
            { title: "Préparer sa maison avant une garde", description: "Guide de la maison, sécurité, animaux.", href: "/blog/preparer-maison-avant-garde", icon: "maison" },
          ];
        } else if (annoncesCount >= 1 && gardesCount === 0) {
          resTitle = "Préparer votre première garde";
          resItems = [
            { title: "Accueillir son gardien", description: "Remise des clés, visite, jour du départ.", href: "/blog/accueillir-gardien-bonnes-pratiques", icon: "proprio" },
            { title: "Préparer sa maison avant une garde", description: "Ce qu'on oublie dans le guide de la maison.", href: "/blog/preparer-maison-avant-garde", icon: "maison" },
            { title: "Que faire si quelque chose se passe mal", description: "Animal malade, panne, gardien défaillant.", href: "/blog/que-faire-probleme-pendant-garde", icon: "proprio" },
          ];
        } else if (gardesCount >= 1) {
          resTitle = "Optimiser vos prochaines gardes";
          resItems = [
            { title: "Choisir son gardien : les bons critères", description: "Affinez votre sélection à chaque garde.", href: "/blog/choisir-gardien-bons-criteres", icon: "proprio" },
            { title: "Que faire si quelque chose se passe mal", description: "Animal malade, panne, gardien défaillant.", href: "/blog/que-faire-probleme-pendant-garde", icon: "proprio" },
            { title: "Accueillir son gardien", description: "Ce qui fait qu'un gardien prend soin de tout.", href: "/blog/accueillir-gardien-bonnes-pratiques", icon: "proprio" },
          ];
        }
