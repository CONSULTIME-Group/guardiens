...
export const CITIES: CityData[] = [
 ...
 metaDescription:
 "Trouvez un home sitter de confiance à Annecy et en Haute-Savoie. Gardiens vérifiés, locaux, disponibles en 15 min. À 0 € pour les propriétaires.",
 localSpots: [
 {
 name: "Lac d'Annecy",
 type: "balade",
 ...
 metaDescription:
 "Home sitting à Grenoble : trouvez un home sitter de confiance en Isère. Gardiens vérifiés, locaux, disponibles rapidement. À 0 € pour les propriétaires.",
 localSpots: [
 {
 ...
 metaDescription:
 "Garde de maison et animaux à Caluire-et-Cuire. Gardiens vérifiés à 15 min. Résidences avec jardin, chiens et chats bienvenus. À 0 € propriétaires.",
 localSpots: [
 {
 ...
 metaDescription:
 "Home sitting à Chambéry : trouvez un home sitter de confiance en Savoie. Gardiens vérifiés, locaux, disponibles rapidement. À 0 € pour les propriétaires.",
 localSpots: [
 {
 name: "Lac du Bourget (rive sud)",
 type: "balade",
 tip: "Sentier plat 8 km, chiens acceptés. Parking à 0 € à Brison-Saint-Innocent.",
 },
 {
 name: "Parc du Verney",
 type: "parc",
