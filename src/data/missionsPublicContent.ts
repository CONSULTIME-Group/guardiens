...
export const MISSIONS_FAQ: { q: string; a: string }[] = [
  ...
  { q: "C'est vraiment gratuit ?", a: "Oui. L'entraide entre gens du coin est gratuite pour tous, sans frais ni commission. Aucune carte bancaire n'est demandée pour publier une mission ou y répondre. Cela fait partie de notre engagement : l'échange a de la valeur précisément parce qu'il n'a pas de prix." },
  ...
  { q: "Faut-il être abonné ?", a: "Non. Les petites missions sont accessibles à tous les membres inscrits, sans abonnement. Seul l'espace gardien (pour proposer des gardes longues) requiert un abonnement à 6,99 €/mois." },
  ...
  { q: "Quelle différence entre une petite mission et une garde sur Guardiens ?", a: "Une garde, c'est une présence dans la durée : un gardien dort chez vous, prend soin de vos animaux et de votre maison pendant votre absence. Une petite mission, c'est un coup de main ponctuel : arroser les plantes, promener un chien une heure, monter un meuble. La garde nécessite un abonnement gardien (6,99 €/mois). Les petites missions sont gratuites pour tous." },
