...
export const staticRoutes: SiteRoute[] = [
 ...
 metaDescription: "Rejoignez la communauté Guardiens. Inscription gratuit pour les propriétaires (à vie), 6,99 €/mois pour les gardiens avec 7 jours d'essai sans engagement.",
 h1: "Créer un compte",
 sitemapPriority: "0.6",
 changeFreq: "monthly",
 },
