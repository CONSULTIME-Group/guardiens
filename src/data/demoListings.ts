...
export const DEMO_MISSIONS = [
  ...
  },
  {
    id: "demo-mission-003",
    is_demo: true,
    title: "Relever le courrier et surveiller la maison — 3 semaines",
    description: "Passage rapide tous les 2-3 jours. Courrier dans la boîte, vérifier que tout va bien.",
    category: "house",
    exchange_offer: "Un dîner à mon retour, avec plaisir",
    city: "Limonest",
    postal_code: "69760",
    status: "open",
    duration_estimate: "15 min × 3/sem",
    date_needed: null,
    created_at: new Date().toISOString(),
    user_id: "demo",
    owner: {
