/**
 * Départements limitrophes (métropole), calculé à partir des contours officiels
 * IGN (france-geojson). Clé : code département, valeur : codes limitrophes.
 * Les départements d'outre-mer n'ont pas de limitrophe terrestre.
 */
export const DEPT_ADJACENCY: Record<string, string[]> = {
