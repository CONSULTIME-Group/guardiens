...
const MySubscription = () => {
 ...
 <p className="text-xs uppercase tracking-widest text-foreground/50 font-body">Après le 15 juillet — la formule</p>
 ...
 <p className="text-base text-foreground/70 font-body">Votre accès complet est offert jusqu'au 15 juillet 2026.</p>
 </div>
 ...
 <p className="text-xs text-amber-600 font-body">Accès offert jusqu'au 15 juillet 2026</p>
 </div>
