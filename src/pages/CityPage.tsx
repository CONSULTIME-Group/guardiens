...
.limit(3);
 ...
 { q: `Est-ce vraiment gratuit pour les propriétaires à ${cityData.name} ?`, a: "Oui. Guardiens est gratuite pour tous les propriétaires. Seuls les gardiens paient un abonnement pour accéder aux annonces et postuler." },
