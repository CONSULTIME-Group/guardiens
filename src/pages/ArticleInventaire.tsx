  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Non. Les propriétaires ne paient rien, jamais. L'espace gardien est ouvert pendant la phase de lancement, aucune commission prélevée sur les gardes.",
        },
      },
    ],
  };
        ...
        <article className="max-w-3xl mx-auto px-4 py-8 animate-fade-in">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-foreground leading-relaxed">
              <p>
                Depuis 2021, en tant que fondateurs, nous avons accompagné 234 animaux et gardé 37 maisons. Cette période a servi à valider une intuition simple : la garde à domicile, à 0 € pour les propriétaires, tient debout quand la confiance est bâtie en amont. Vérification d'identité, avis croisés, badges publics, Trust Score : rien de tout cela n'est cosmétique.
              </p>
              <p>
