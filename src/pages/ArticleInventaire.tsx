  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Non. Les propriétaires ne paient rien, jamais. Les gardiens souscrivent un abonnement modeste (6,99 €/mois ou 12 € en paiement unique), sans commission sur les gardes.",
        },
      },
    ],
  };
