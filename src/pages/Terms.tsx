  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <PageMeta
        ...
        description="Consultez les conditions générales d'utilisation (version 4) de la plateforme Guardiens."
        path="/cgu"
      />
      <PublicHeader />
      ...
      <main className="px-6 md:px-12 py-16 max-w-3xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground mb-8">
          Version 4 — Dernière mise à jour : 3 mai 2026
        </p>
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
          ...
          <p>
            Les présentes Conditions Générales d'Utilisation (ci-après « CGU ») régissent l'accès et l'utilisation de la Plateforme, qui met en relation des propriétaires de logements et d'animaux avec des gardiens, dans une logique d'échange de bons procédés non lucratif (house-sitting).
          </p>
          <p>
            L'utilisation de la Plateforme implique l'acceptation pleine et entière des présentes CGU. Cette acceptation se matérialise lors de la création du compte par une case à cocher distincte et non pré-cochée. L'utilisateur reconnaît avoir pris connaissance des CGU et de la <a href="/confidentialite" className="text-primary hover:underline">Politique de confidentialité</a> avant validation de son inscription.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong className="text-foreground">Régime « hébergeur »</strong> au sens de l'article 6-I-2 de la LCEN pour les contenus utilisateurs (annonces, profils, photos, avis, messages, candidatures). Guardiens n'a pas d'obligation générale de surveillance ; sa responsabilité ne peut être engagée du fait de ces contenus que si, dûment notifiée dans les conditions de l'article 13, elle n'a pas agi promptement pour les retirer.</li>
          </ul>
          <p>
          ...
          <p>
            L'inscription est strictement réservée aux personnes physiques majeures (18 ans révolus) capables juridiquement. La Plateforme n'est pas accessible aux mineurs.
          </p>
          <p>
            L'utilisateur s'engage à fournir des informations exactes, complètes et à jour. Toute fausse déclaration concernant l'âge ou l'identité entraîne la suspension immédiate du compte, sans préjudice des poursuites éventuelles.
          </p>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">5.2 Sécurité du compte</h3>
          <p>
          ...
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">5.3 Acceptation explicite</h3>
          <p>
            L'acceptation des CGU s'effectue par une case à cocher non pré-cochée, distincte de toute autre acceptation (notamment marketing). La case d'acceptation des CGU est obligatoire pour finaliser l'inscription. Le consentement marketing fait l'objet d'une case séparée et facultative.
          </p>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">5.4 Protection des mineurs</h3>
          <p>
            Conformément à l'article 8 du RGPD et à la loi pour une République numérique, Guardiens prend les mesures appropriées pour empêcher l'inscription de mineurs. Toute information révélant qu'un compte a été créé par un mineur entraîne la suppression immédiate du compte et l'effacement des données associées. Les utilisateurs sont expressément interdits de publier des photographies de mineurs identifiables sans le consentement écrit de leurs représentants légaux.
          </p>

          {/* 6 */}
          <h2 className="font-heading text-xl font-bold text-foreground pt-4">6. Services proposés et tarification</h2>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">6.1 Services</h3>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">6.2 Tarifs</h3>
          <table className="w-full text-sm border border-border">
            ...
            <tbody>
              <tr className="border-t border-border"><td className="p-2">Espace Propriétaire</td><td className="p-2">0 € à vie, sans carte bancaire requise, sans limite de durée</td></tr>
              <tr className="border-t border-border"><td className="p-2">Espace Gardien (standard)</td><td className="p-2">6,99 € TTC/mois, sans engagement, résiliable à tout moment depuis l'espace personnel</td></tr>
              <tr className="border-t border-border"><td className="p-2">Petites missions (entraide)</td><td className="p-2">0 € à vie pour tous les membres, sans condition d'abonnement</td></tr>
            </tbody>
          </table>
          <p>
            <strong className="text-foreground">Période d'essai</strong> : un essai gratuit de 7 jours est proposé lors de la première souscription Gardien. À l'issue de la période d'essai, l'abonnement n'est pas reconduit automatiquement : l'utilisateur choisit explicitement de poursuivre par une action positive depuis son espace personnel.
          </p>
          <p>
            <strong className="text-foreground">Période de lancement</strong> : jusqu'au 13 juin 2026, l'accès Gardien est intégralement offert (0 €). À compter du 14 juin 2026, l'abonnement à 6,99 € TTC/mois devient nécessaire pour postuler aux gardes.
          </p>
          <p>
            <strong className="text-foreground">Programme Fondateur</strong> : les utilisateurs inscrits avant le 13 juin 2026 bénéficient de conditions préférentielles détaillées sur la <a href="/tarifs" className="text-primary hover:underline">page Tarifs</a>.
          </p>
          <p>
            <strong className="text-foreground">Parrainage</strong> : un mois d'abonnement Gardien offert par filleul actif, dans les conditions précisées sur la page dédiée.
          </p>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">6.3 Absence de commission</h3>
          <p>
          ...
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">6.4 Reconduction et information préalable</h3>
          <p>
            L'abonnement Gardien est reconduit tacitement chaque mois jusqu'à résiliation par l'utilisateur. Conformément à l'article L. 215-1 du Code de la consommation, l'utilisateur peut résilier à tout moment depuis son espace personnel, sans frais ni pénalité.
          </p>
          <p>
            Conformément à l'article L. 224-42 du Code de la consommation, la résiliation est possible en ligne, par un bouton accessible depuis l'espace personnel, en quelques étapes.
          </p>

          {/* 7 */}
          <h2 className="font-heading text-xl font-bold text-foreground pt-4">7. Nature de la relation entre utilisateurs</h2>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">7.1 Rôle d'intermédiaire</h3>
          <p>
            Guardiens agit exclusivement en tant qu'intermédiaire technique de mise en relation. La Plateforme n'est ni partie, ni mandataire, ni garante des accords conclus entre utilisateurs.
          </p>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">7.2 Qualification juridique</h3>
          <p>
            Le house-sitting tel que proposé sur Guardiens repose sur un échange de bons procédés (garde d'animaux contre hébergement à titre gratuit) à titre non lucratif. Il ne constitue pas :
          </p>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">7.3 Conditions matérielles de la garde</h3>
          <p>
          ...
          <p>
            Guardiens met à disposition un guide pratique non contractuel ainsi qu'un dispositif d'accord de garde optionnel et non bloquant.
          </p>

          {/* 8 */}
          <h2 className="font-heading text-xl font-bold text-foreground pt-4">8. Petites missions (entraide)</h2>
          <p>
            Les petites missions sont des échanges d'entraide ponctuels entre membres, sans nuitée. Elles fonctionnent exclusivement sur le principe de l'<strong className="text-foreground">échange en nature</strong> (repas, produits du jardin, service réciproque). Tout échange d'argent est strictement interdit et expose le compte à une suspension immédiate.
          </p>
          <p>
            Ces échanges entre particuliers, à titre non lucratif et sans recherche de profit, ne constituent pas, en principe, des revenus imposables (cf. BOI-IR-BASE-10-10-10-10 et instruction fiscale du 30 août 2016 relative aux revenus issus de l'économie collaborative). Chaque utilisateur reste néanmoins seul responsable de ses obligations déclaratives au titre de la solidarité et de l'entraide entre particuliers.
          </p>
          ...
          <p>
            Guardiens propose un système optionnel de vérification d'identité reposant sur l'analyse d'un document officiel par un prestataire spécialisé agissant en qualité de sous-traitant au sens de l'article 28 du RGPD. Cette vérification atteste qu'un utilisateur a soumis un document jugé conforme. Elle ne constitue pas une garantie absolue de fiabilité, d'honnêteté ou de compétence de l'utilisateur.
          </p>
          <p>
            La base légale du traitement est le consentement (art. 6.1.a RGPD). Les modalités de conservation et de suppression des données sont détaillées dans la <a href="/confidentialite" className="text-primary hover:underline">Politique de confidentialité</a>.
          </p>
          <p>
            L'utilisateur peut retirer son consentement et demander la suppression de ses pièces à tout moment depuis son espace personnel ou par email à <a href="mailto:dpo@guardiens.fr" className="text-primary hover:underline">dpo@guardiens.fr</a>.
          </p>
          ...
          <p>
            Guardiens accuse réception du signalement et l'examine dans un délai cible de 14 jours ouvrés. Toute décision de modération (retrait, déréférencement, restriction de visibilité, suspension ou résiliation de compte) est motivée et notifiée à l'utilisateur concerné, conformément à l'article 17 du DSA.
          </p>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">13.3 Recours interne</h3>
          <p>
            Conformément à l'article 20 du DSA, l'utilisateur destinataire d'une décision de modération dispose d'un droit de recours interne à exercer dans un délai de 6 mois auprès de <a href="mailto:contact@guardiens.fr" className="text-primary hover:underline">contact@guardiens.fr</a>. Le recours est examiné par une personne distincte de celle ayant pris la décision initiale, dans un délai de 14 jours ouvrés.
          </p>
          <p>À défaut de résolution interne satisfaisante, l'utilisateur peut recourir aux voies prévues à l'article 23 des présentes CGU.</p>
          ...
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">14.1 Éléments Guardiens</h3>
          <p>
          ...
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">14.2 Contenus utilisateurs</h3>
          <p>
            Les utilisateurs conservent l'intégralité de leurs droits sur les contenus qu'ils publient. Ils accordent à Guardiens, conformément à l'article L. 131-3 du CPI, une licence non exclusive, gratuite, pour le monde entier, pour la durée strictement nécessaire à la diffusion sur la Plateforme, augmentée d'un délai technique maximal de 30 jours permettant la purge des sauvegardes, aux seules fins :
          </p>
          <ul className="list-disc pl-6 space-y-1">
          ...
          <p>
            Conformément à l'article L. 221-18 du Code de la consommation, l'utilisateur consommateur dispose d'un délai de 14 jours à compter de la souscription de l'abonnement Gardien pour exercer son droit de rétractation, sans avoir à motiver sa décision ni à supporter de pénalités.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>ou utiliser le formulaire-type de rétractation reproduit ci-dessous (annexe à l'art. R. 221-1 C. conso) :</li>
          </ul>
          ...
          <p>
            Le remboursement intervient dans un délai de 14 jours à compter de la réception de la demande, par le même moyen de paiement que celui utilisé pour la transaction initiale, sauf accord exprès contraire.
          </p>
          <p>
            <strong className="text-foreground">Renonciation expresse</strong> : conformément à l'article L. 221-25 du Code de la consommation, l'utilisateur qui souhaite que l'exécution du service commence avant l'expiration du délai de 14 jours doit en faire la demande expresse, par une case à cocher distincte de l'acceptation des CGU lors de la souscription. Dans ce cas, il reconnaît perdre son droit de rétractation dès que la prestation est pleinement exécutée.
          </p>

          {/* 16 */}
          <h2 className="font-heading text-xl font-bold text-foreground pt-4">16. Résiliation et suppression de compte</h2>
          <p>
            L'utilisateur peut résilier son abonnement et supprimer son compte à tout moment depuis les paramètres de son profil. La suppression entraîne une période de grâce de 30 jours durant laquelle le compte peut être réactivé. Au-delà, les données de profil sont supprimées ou anonymisées conformément à la <a href="/confidentialite" className="text-primary hover:underline">Politique de confidentialité</a> ; les avis publiés sont conservés sous forme anonymisée (cf. article 11) sur le fondement de l'intérêt légitime.
          </p>
          <p>
            Aucun remboursement prorata temporis n'est effectué pour la fraction d'abonnement déjà entamée, sauf exercice du droit de rétractation dans le délai légal (article 15).
          </p>

          {/* 17 */}
          <h2 className="font-heading text-xl font-bold text-foreground pt-4">17. Modification des CGU</h2>
          <p>
            Guardiens se réserve le droit de modifier les présentes CGU. Les utilisateurs sont informés par notification sur la Plateforme et par email au moins 30 jours avant l'entrée en vigueur de toute modification substantielle.
          </p>
          <p>Sont considérées comme modifications substantielles :</p>
          <ul className="list-disc pl-6 space-y-1">
            <li>toute évolution tarifaire ;</li>
          ...
          <p>
            En cas de refus des nouvelles conditions, l'utilisateur dispose du droit de résilier son compte sans frais ni pénalité avant la date d'entrée en vigueur. L'utilisation continue de la Plateforme après cette date vaut acceptation des nouvelles conditions.
          </p>
          ...
          <p>
            La Plateforme utilise des cookies strictement nécessaires à son fonctionnement ainsi que des cookies de mesure d'audience soumis au consentement préalable de l'utilisateur, conformément à l'article 82 de la loi Informatique et Libertés. Le refus est aussi simple que l'acceptation, et n'empêche pas l'accès au service.
          </p>
          ...
          {/* 23 */}
          <h2 className="font-heading text-xl font-bold text-foreground pt-4">23. Réclamations et résolution des litiges</h2>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">23.1 Procédure amiable</h3>
          <p>
            Toute réclamation doit être adressée par écrit à <a href="mailto:contact@guardiens.fr" className="text-primary hover:underline">contact@guardiens.fr</a>. Guardiens s'engage à accuser réception sous 7 jours ouvrés et à apporter une réponse motivée dans un délai maximal de 30 jours.
          </p>
          <h3 className="font-heading text-lg font-semibold text-foreground pt-2">23.2 Voies de recours</h3>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>la <strong className="text-foreground">juridiction compétente</strong> conformément à l'article 24.</li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><strong className="text-foreground">Email DPO</strong> : <a href="mailto:dpo@guardiens.fr" className="text-primary hover:underline">dpo@guardiens.fr</a></li>
          </ul>
        </div>
      </main>
