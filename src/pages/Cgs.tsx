    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="px-6 md:px-12 py-16 max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
          ...
          <p>
            Jusqu'au 13 juin 2026, l'accès Gardien est intégralement offert. À compter du 14 juin 2026, l'abonnement à 6,99&nbsp;€ TTC/mois devient nécessaire pour postuler aux gardes.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>Accès gratuit à l'ensemble des fonctionnalités Gardien jusqu'au 13 juin 2026&nbsp;;</li>
            <li>Badge Fondateur permanent affiché sur leur profil&nbsp;;</li>
            <li>Reconduction au tarif standard de 6,99&nbsp;€ TTC/mois à compter du 14 juin 2026, sauf résiliation préalable.</li>
          </ul>
