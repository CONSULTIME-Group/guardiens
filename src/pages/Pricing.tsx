...
À partir du 14 juin 2026, l'abonnement gardien à 6,99 €/mois devient nécessaire pour postuler aux gardes. L'espace propriétaire, lui, reste gratuit.`,
 },
 {
...
**Le programme Fondateur** est un statut symbolique réservé aux personnes inscrites **avant le 13 mai 2026**. Il donne droit à un badge Fondateur affiché sur le profil sur le profil — ce badge ne sera plus jamais attribué après cette date.
...
Plutôt que de recevoir des cadeaux, il a décidé de marquer cette date avec le programme Fondateur : les personnes inscrites avant le 13 mai 2026 reçoivent un **badge Fondateur affiché sur le profil** sur leur profil. Ce badge ne sera plus jamais attribué après cette date.
...
const Pricing = () => {
 ...
 title={
 before
 ? "Tarifs Guardiens — Offert pour tous jusqu'au 13 juin"
 : "Tarifs Guardiens — Offert propriétaires · 6,99 €/mois"
 }
 description={
 before
 ? "Accès complet offert jusqu'au 13 juin 2026 pour tous, gardiens comme propriétaires. Sans carte bancaire, sans commission, sans frais cachés."
 ...
 Inscrivez-vous avant le 13 mai pour recevoir le badge Fondateur
 </p>
