...
const promiseRows: Array<{ label: string; value: string; positive: boolean }> = [
 ...
 { label: "Entraide & petites missions", value: "Gratuites", positive: true },
...
const faqItems = [
 {
 q: "L'accès est-il vraiment gratuit pour tout le monde jusqu'au 13 juillet 2026 ?",
 a: `Oui. Jusqu'au 13 juillet 2026, **l'accès complet à Guardiens est 100% gratuit pour tout le monde** — gardiens comme propriétaires, sans aucune exception.
...
Cette gratuité totale ne dépend pas du programme Fondateur. Que vous vous inscriviez le 1er février ou le 12 juin 2026, vous ne payez rien jusqu'au 13 juillet 2026.

À partir du 14 juillet 2026, l'abonnement gardien à 6,99 €/mois devient nécessaire pour postuler aux gardes. L'espace propriétaire, lui, reste gratuit.`,
 },
 {
 q: "Quelle est la différence entre la gratuité jusqu'au 13 juillet et le programme Fondateur ?",
 a: `Ce sont deux choses distinctes qui se cumulent.

**La gratuité totale jusqu'au 13 juillet 2026** concerne **tous les inscrits**, sans condition de date. Personne ne paie avant cette date.
...
En clair : tout le monde est gratuit jusqu'au 13 juillet, et seuls les premiers inscrits (avant le 13 juin) reçoivent en plus le badge Fondateur.`,
 },
 {
...
Pour comprendre comment fonctionne la mise en relation : [Comment bien choisir son gardien →](/actualites/choisir-gardien-bons-criteres)`,
 ...
 a: `Cet essai s'applique **après le 13 juillet 2026**, lorsque l'abonnement gardien devient payant.
...
Avant le 13 juillet 2026, cet essai n'a pas lieu d'être : tout est déjà gratuit pour tout le monde.`,
 },
 {
...
À ne pas confondre avec la gratuité : **tout le monde est gratuit jusqu'au 13 juillet 2026**, qu'il s'inscrive avant ou après le 13 juin. Le 13 juin concerne uniquement le badge.`,
 },
 {
 q: "Y a-t-il des frais cachés ?",
 a: `Non. **Jusqu'au 13 juillet 2026 :** rien à payer pour personne, sans carte bancaire.

**Après le 13 juillet 2026 — ce que paient les gardiens :** 6,99 €/mois, 12 € pour un mois, ou la formule 2026 à -20%. C'est tout.
...
const Pricing = () => {
 ...
 title={
 before
 ? "Tarifs Guardiens — Offert pour tous jusqu'au 13 juillet"
 : "Tarifs Guardiens — Offert propriétaires · 6,99 €/mois"
 }
 description={
 before
 ? "Accès complet offert jusqu'au 13 juillet 2026 pour tous, gardiens comme propriétaires. Sans carte bancaire, sans commission, sans frais cachés."
 ...
 {before
 ? "Jusqu'au 13 juillet 2026, l'accès complet est offert — gardiens comme propriétaires. Aucune carte bancaire demandée."
 ...
 <h2 className="font-heading text-2xl font-bold text-foreground">Les Fondateurs ont jusqu'au 13 juillet</h2>
 <p className="text-muted-foreground max-w-2xl mx-auto font-body">
 Les membres inscrits avant le 13 juin conservent leur accès gratuit jusqu'au 13 juillet.
 ...
 Puis <span className="font-semibold text-foreground">6,99 €/mois</span> à partir du 14 juillet 2026
 </p>
 </div>
 ) : (
 <div className="text-center space-y-1.5 py-2">
