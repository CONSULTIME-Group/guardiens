    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="px-6 md:px-12 py-16 max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
          ...
          <p>
            Compte tenu de la nature de certains traitements (vérification d'identité, géolocalisation, communications entre membres), une <strong className="text-foreground">analyse d'impact relative à la protection des données</strong> (AIPD) sera réalisée conformément à l'article 35 du RGPD avant le 1er juillet 2026, date du passage payant. Cette analyse est mise à jour à chaque évolution majeure du service.
          </p>
