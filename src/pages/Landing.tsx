...
const Landing = () => {
 ...
 name: "Pet sitting & House sitting de proximité",
  ...
  { "@type": "Offer", name: "Abonnement gardien", price: "6.99", priceCurrency: "EUR", description: "Abonnement gardien à 6,99 €/mois après le 30 juin 2026 — accès sans abonnement jusqu'à cette date." },
 ...
 { "@type": "Question", name: "Qu'est-ce que le house sitting ?", acceptedAnswer: { "@type": "Answer", text: "Le house sitting est un échange de services : un gardien habite gratuitement dans votre maison pendant votre absence et prend soin de vos animaux. L'échange n'implique aucune transaction financière entre les deux parties." } },
  { "@type": "Question", name: "Faut-il payer pour s'inscrire en tant que propriétaire ?", acceptedAnswer: { "@type": "Answer", text: "L'inscription, la publication d'annonces et les échanges avec les gardiens sont sans abonnement requis pour les propriétaires. Aucune carte bancaire demandée. Les gardiens bénéficient d'un accès sans abonnement jusqu'au 30 juin 2026, puis l'abonnement est à 6,99 €/mois. L'entraide entre gens du coin reste sans abonnement pour tous." } },
 ...
 <p className="mt-3 md:mt-4 text-muted-foreground text-[15px] md:text-base leading-relaxed">
 ...
 <p className="mt-3 text-xs text-muted-foreground font-body">
 Pour les propriétaires · Sans carte bancaire
 </p>
 </RevealSection>
 </div>
 </section>
 ...
 <p className="text-center text-foreground/60 font-body max-w-2xl mx-auto mb-16">
 Des gardiens vérifiés près de chez vous, disponibles rapidement. Gratuit pour les propriétaires.
 </p>
 </RevealSection>
 ...
 Badge Fondateur. Accès gratuit jusqu'au 30 juin. Et surtout, vous serez parmi les premiers à vivre ça. Pourquoi le 13 juin ? C'est l'anniversaire de Jérémie. Il préfère offrir l'accès plutôt que recevoir des chaussettes.
 </p>
 <button
 ...
 Badge Fondateur · Accès offert jusqu'au 30 juin · L'entraide reste sans frais
 </p>
 </RevealSection>
 </section>
