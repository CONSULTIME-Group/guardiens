  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <TooltipProvider delayDuration={200}>
        <div className="fixed bottom-20 md:bottom-0 left-0 right-0 z-40 bg-background/95 backdrop-blur-sm border-t border-border py-3 px-4 md:py-4 md:px-6 flex items-center justify-between gap-3 before:pointer-events-none before:content-[''] before:absolute before:left-0 before:right-0 before:-top-6 before:h-6 before:bg-gradient-to-t before:from-background before:to-transparent">
