...
export const LAUNCH_DATE = new Date("2026-06-14T00:00:00Z");
export const LAUNCH_START = new Date("2026-05-07T00:00:00Z");
export const FOUNDER_START = new Date("2026-06-13T00:00:00Z");
export const GRACE_END = new Date("2026-07-14T00:00:00Z");
