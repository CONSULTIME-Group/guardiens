/**
 * missingOpportunities — bloc « occasions manquées » du dashboard gardien.
 *
 * Doctrine : un champ non renseigné est neutre dans le score d'affinité, mais
 * jamais silencieux à l'écran. Ce bloc nomme au maximum DEUX manques à la
 * fois, formulés en annonces réelles recalculées à l'affichage :
 ...
 *
 * Logique pure et testable : la donnée vient de la RPC
 * `sitter_missing_opportunities` (compteurs sur les annonces publiées,
