...
export type EventType =
  ...
  | "sit_exit_choice_shown"            // Écran de choix affiché : annonce prête, sortie sans publier (exit)
  | "sit_exit_choice_publish"          // Choix de sortie : publier maintenant (sit_id)
  | "sit_exit_choice_keep_draft"       // Choix de sortie : garder en brouillon (reason ou "skipped")
