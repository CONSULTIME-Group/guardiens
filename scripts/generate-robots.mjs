...
function buildRobotsTxt({ siteUrl, privatePaths, noindexFromStatic }) {
  ...
  const lines = [
    ...
    "# et listee au sitemap si et seulement si elle passe la regle de substance",
    "# (src/lib/sitterProfileIndexability.js) : bio d'au moins 80 caracteres et",
    "# au moins un signal de confiance. Les autres rendent noindex, follow.",
    "# Aucun Disallow ici, sinon la desindexation des fiches non eligibles serait bloquee.",
